...
func (o *GetUserRobotOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *GetUserRobotBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *GetUserRobotUnauthorized) Error() string {
	return fmt.Sprintf("[GET /api/v1/user/robots/{robot_shortname}][%d] getUserRobotUnauthorized  %+v", 401, o.Payload)
}

func (o *GetUserRobotUnauthorized) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *GetUserRobotForbidden) Error() string {
	return fmt.Sprintf("[GET /api/v1/user/robots/{robot_shortname}][%d] getUserRobotForbidden  %+v", 403, o.Payload)
}

func (o *GetUserRobotForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *GetUserRobotNotFound) Error() string {
	return fmt.Sprintf("[GET /api/v1/user/robots/{robot_shortname}][%d] getUserRobotNotFound  %+v", 404, o.Payload)
}

func (o *GetUserRobotNotFound) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
